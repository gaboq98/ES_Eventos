...
namespace ES_Eventos_web_app.Controllers
{
    public class AdministradoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,cedula,correo,contrsena,estado")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,cedula,correo,contrsena,estado")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
